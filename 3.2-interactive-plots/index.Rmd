...
- `plotly`: has come a long way in the last 12 months, part of Carson Sievert's PhD thesis research. The beuty is that is builds directly onto ggplot2
...
p <- ggplot(sig.tab, aes(x=C_S1_R2, y=C_S2_R1, label=genes)) +
  geom_point(alpha=0.1) + theme(aspect.ratio=1)
ggplotly(p)
```
